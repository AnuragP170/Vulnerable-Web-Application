pipeline {
    ...
    stages {
        ...
        //                 sh "/var/jenkins_home/tools/hudson.plugins.sonar.SonarRunnerInstallation/SonarQube/bin/sonar-scanner -Dsonar.projectKey=OWASP -Dsonar.sources=. -Dsonar.host.url=http://192.168.xx.xx:9000 -Dsonar.token=sqp_e9db62f8651602d9681fe664464d84d157e771bfxxxxxx"
        //             }
        //         }
        //     }
        // }
